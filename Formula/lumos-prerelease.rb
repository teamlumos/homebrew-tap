class LumosPrerelease < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/teamlumos/lumos-cli/releases/download/2.1.2-prerelease/lumos-darwin-amd64.tar.gz"
      sha256 "415a9c5ecca9d43642d1d5f82be0f3ed98c3f42a175a569988e2124ba521ebb7"
    elsif Hardware::CPU.arm?
      url "https://github.com/teamlumos/lumos-cli/releases/download/2.1.2-prerelease/lumos-darwin-arm64.tar.gz"
      sha256 "415a9c5ecca9d43642d1d5f82be0f3ed98c3f42a175a569988e2124ba521ebb7"
    end
  end
